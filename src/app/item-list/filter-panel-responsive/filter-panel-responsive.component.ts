...
@Component({
  ...
  templateUrl: './filter-panel-responsive.component.html',
  styleUrls: ['./filter-panel-responsive.component.scss']
})
export class FilterPanelResponsiveComponent implements OnInit {
  ...
  /**
   * Filters have been applied with previous methods.
   * Just closes filter panel.
   */
  onApplyAllFilters() {
    this.itemList.closeResponsiveFilter();
  }
